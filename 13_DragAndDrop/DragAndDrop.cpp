...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_DROPFILES:
	{
		...
		int count = DragQueryFile(droppedFile, 0xFFFFFFFF, filePath, MAX_PATH);

		for (int i = 0; i < count; i++)
		{
			DragQueryFile(droppedFile, i, filePath, MAX_PATH);
			MessageBox(GetForegroundWindow(), filePath, TEXT("C F R"), MB_OK);
		}
